...
import (
	...
	"go-micro/naming/circuitbreaker"
	"go-micro/naming/discovery"
	"go-micro/naming/loadbalance"
	"go-micro/naming/registry"
	"go-micro/naming/selector"
	"go-micro/naming/servicerouter"
	"go-micro/pool/connpool"
	"go-micro/pool/multiplexed"
	"go-micro/transport"
)
