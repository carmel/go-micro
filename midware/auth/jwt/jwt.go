...
var (
	...
	ErrWrongContext           = errors.Unauthorized(reason, "Wrong context for midware")
...
// Server is a server auth midware. Check the token and extract the info from token.
func Server(keyFunc jwt.Keyfunc, opts ...Option) midware.Midware {
	o := &options{
...
// Client is a client jwt midware.
func Client(keyProvider jwt.Keyfunc, opts ...Option) midware.Midware {
