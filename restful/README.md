...
Please refer to the [trpc-go/restful](/restful).
...
RESTful also supports [trpc-filter/cors](https://github.com/trpc-ecosystem/go-filter/tree/main/cors) cross-origin requests 
plugin. To use it, you need to add the HTTP OPTIONS method in pb by using `custom`, for example:
