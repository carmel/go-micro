...
import (
	...
	"github.com/carmel/microservices/gateway/config"
	configLoader "github.com/carmel/microservices/gateway/config/config-loader"
	"github.com/carmel/microservices/gateway/discovery"
	"github.com/carmel/microservices/gateway/midware"
	"github.com/carmel/microservices/gateway/proxy"
	"github.com/carmel/microservices/gateway/proxy/debug"
	"github.com/carmel/microservices/gateway/server"

	_ "net/http/pprof"

	_ "github.com/carmel/microservices/gateway/discovery/consul"
	_ "github.com/carmel/microservices/gateway/midware/bbr"
	"github.com/carmel/microservices/gateway/midware/breaker"
	_ "github.com/carmel/microservices/gateway/midware/cors"
	_ "github.com/carmel/microservices/gateway/midware/logging"
	_ "github.com/carmel/microservices/gateway/midware/rewrite"
	_ "github.com/carmel/microservices/gateway/midware/tracing"
	_ "github.com/carmel/microservices/gateway/midware/transcoder"
