...
// CodecForRequest get cc.Codec via http.Request
func CodecForRequest(r *http.Request, name string) (cc.Codec, bool) {
	for _, accept := range r.Header[name] {
		codec := cc.GetCodec(httputil.ContentSubtype(accept))
		if codec != nil {
			return codec, true
		}
	}
	return cc.GetCodec("json"), false
}
