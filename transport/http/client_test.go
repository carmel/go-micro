...
func TestWithMiddleware(t *testing.T) {
	...
	WithMidware(v...)(o)
	if !reflect.DeepEqual(o.midware, v) {
		t.Errorf("expected midware to be %v, got %v", v, o.midware)
	}
}
...
func TestNewClient(t *testing.T) {
	...
	client, err := NewClient(
		...
		WithMidware(func(handler midware.Handler) midware.Handler {
			t.Logf("handle in midware")
